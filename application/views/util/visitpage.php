      ...
      <div id="container" style="margin: 0px;padding: 40px 40px 10px 40px;page-break-after: always;">
...
//                                                  $diff = $diff < 0 ? 0 : $diff;
        ...
        <table style="width: 100%;margin-top: 40px;">
              ...
              <tr>
                  <td style="border-right: 1px solid #999;padding:0px 5px;vertical-align: top;padding-top: 30px;">
                      <table class="avbl_meds">
                          ...
                          <tr>
                              <td style="padding-bottom: 8px;"><strong>Qty Avl: </strong><?php echo $prior['available'];?></td>
                          </tr>
                          <?php } ?>
                      </table>                      
                  </td>
                  <td style="border-right: 1px solid #999;padding:0px 5px;vertical-align: top;padding-top: 30px;">
                      <table class="avbl_meds">
                          ...
                          <tr>
                              <td style="padding-bottom: 6px;"><strong>Qty: </strong><?php echo $prior['available'];?></td>
                          </tr>
                          <?php } ?>
                      ...
                      <table id="tbl_allergies">
                          ...
                          <tr><td style="height: 160px;">Dr’s Alerts:
                              <?php foreach($dralerts as $alert){?> 
                                  <p style="font-weight: bold;">&nbsp;&nbsp;&nbsp;<?php echo $alert->msg;?></p>
                              <?php } ?>
                            </td></tr>
          ...
          <table class="bottom_tbl" style="margin-top: 10px;">
              ...
              <tr>
                  <td style="text-align: left;">MA Name: ....................................................</td>
                  <td style="font-weight: bold;">MEDS</td>
                  <td style="font-weight: bold;">NO MEDS</td>
                  <td style="font-weight: bold;">SHOTS ONLY</td>
                  <td style="border: 1px solid #999;padding: 5px 0px;">37.5mg / 30mg / 15mg / DI 25mg</td>
                  <td style="border: 1px solid #999;width: 150px;"></td>
              </tr>
          </table>
      </div>