                                ...
                                <table class="align-left" style="font-size: 20px;">
                                    <tr class="">
                                        <td colspan="2" class="bold" style="height: 105px;vertical-align: top;text-align: left;">
                                            ...
                                            <img src="/phpThumb/phpThumb.php?src=<?php echo base_url();?>assets/upload/patients/<?php echo $patient->photo;?>&amp;h=100&amp;f=png" />
                                            <?php }else{ 
                                                $gender_img = $patient->gender == 1 ? "male.png":"female.png";
                                            ?>                                  
                                            <img src="/phpThumb/phpThumb.php?src=<?php echo base_url();?>assets/img/<?php echo $gender_img;?>&amp;h=100&amp;f=png" />
                                            <?php } ?>
                                        </td>
                                    </tr>
