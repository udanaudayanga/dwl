    ...
    <div class="col-xs-12">
        <div class="card">
            ...
            <div class="card-body patients_list" style="padding: 15px;">
                ...
                <?php } ?>
                <table id="all_patients" class="table table-striped" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th>Name</th>
                            <th>Telephone</th>
            ...
            <div class="modal-body" style="overflow: auto;">
                ...
                <form id="add_appoint_form" >
                    ...
                    <div class="col-xs-12" style="font-size: 20px;">
                        <div class="col-sm-5 col-xs-12"><strong>STATUS:</strong> &nbsp;&nbsp;<span id="appt_status"></span></div>
                        <!--<div class="col-sm-4 col-xs-12"><strong>LAST STATUS DATE:</strong>&nbsp;&nbsp;<span id="appt_lsd"></span></div>-->
                        <div class="col-sm-7 col-xs-12" id="appt_nvd" style="color: red;"></div>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
...
<script type="text/javascript">
    $(function(){   
        ...
        var dataTable = $('#all_patients').DataTable({
            "processing":true,
            "serverSide":true,
            "order":[],
            "ajax":{
            ...
            "searchDelay": 350,
            "language": {
                processing: "<i class='fa fa-spinner fa-pulse fa-2x'>",
            }
        });
                
        $('.patients_list').on('click','.appt',function(e){
             e.preventDefault();
