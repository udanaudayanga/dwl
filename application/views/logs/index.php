            ...
            <div class="card-body" style="padding: 15px 0px;">
                <div class="form-inline col-xs-12">
                    <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 10px;">
                        <label class="col-xs-2" for="exampleInputName3">Location : </label>
                     ...
                     <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12" style="">
                        <label class="col-xs-2" for="exampleInputName3">Date : </label>
                    ...
                    <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12" style="">
                        <button class="btn btn-success" id="log_print" style="margin: 10px 0 0 20px;font-size: 16px;">Print Log</button>
                    </div>
                </div>
            </div>
        </div>
