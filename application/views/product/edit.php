...
<div class="row">
	...
	<div class="card">
		...
		<form  method="POST" enctype="multipart/form-data">
			...
			<img src="/phpThumb/phpThumb.php?src=/assets/upload/products/<?php echo $product->photo;?>&amp;w=200&amp;f=png" />
		    </div>
		    <?php } ?>
...
`			<label for="price">Price</label>
			...
			<input type="text" placeholder="" name="quantity" id="quantity" value="<?php echo set_value('quantity',$product->quantity);?>" class="form-control">
		    </div>
			...
			<label for="cat">Measured In</label>
			    ...
			    <option <?php echo set_select('measure_in', 'Quantity',$product->measure_in == 'Quantity'); ?> value="Quantity">Physical Qty</option>
			    <option <?php echo set_select('measure_in', 'Days',$product->measure_in == 'Days'); ?> value="Days">Days</option>
			</select>
		    </div>
                    <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
			...
			<label for="pre_paid">&nbsp;</label>
                        <div class="checkbox3 checkbox-round">
                            <input name="prepaid" type="checkbox" value="1" <?php echo set_checkbox('prepaid',1, $product->prepaid == 1); ?> id="checkbox-1">
			...
			<input type="text" placeholder="User Friendly Name" name="friendly_name" value="<?php echo set_value('friendly_name',$product->friendly_name);?>" id="ufn" class="form-control">
		    </div>
			...
			<label for="is_stock">Is this a inventory item?</label>
                        <div class="checkbox3 checkbox-round">
                            <input name="is_stock" type="checkbox" class="pull-right" id="is_stock" value="1" <?php echo set_checkbox('is_stock', 1, $product->is_stock==1); ?>>
			...
			<label for="stock_item">Select Related Inventory Item</label>
			    ...
			    <?php foreach($stockPros as $cats){
                            ...
                            <optgroup label="<?php echo $cats['name'];?>">
                                ...
                                <option <?php echo set_select('stock_item', $pro['id'],$pro['id'] == $product->stock_item); ?> value="<?php echo $pro['id'];?>"><?php echo $pro['name'];?></option>
                                <?php } ?>
                            </optgroup>
			...
			<label for="is_combo">Is this a combo product?</label>
                        <div class="checkbox3 checkbox-round">
                            <input name="is_combo" type="checkbox" class="pull-right" id="is_combo" value="1" <?php echo set_checkbox('is_combo', '1',$product->is_combo==1); ?>>
			...
			<label for="combo_item">Select Second Stock Item</label>
			    ...
			    <?php foreach($stockPros as $cats){
                            ...
                            <optgroup label="<?php echo $cats['name'];?>">
                                <?php foreach($pros as $pro){?>
                                <option <?php echo set_select('stock_item', $pro['id'],$pro['id'] == $product->combo_item); ?> value="<?php echo $pro['id'];?>"><?php echo $pro['name'];?></option>
                                <?php } ?>
                            </optgroup>
			    ...
			    <?php } ?>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 15px;">
                        <h4 style="font-family: 'Roboto Condensed',sans-serif;font-size: 1.4em;text-decoration: none;"><div class="col-lg-2 col-md-3 col-sm-3 col-xs-7 no-padding">Any additional free products</div> &nbsp; 
                            <div class="checkbox3 checkbox-round col-lg-3 col-md-4 col-sm-4 col-xs-3">
                                <input type="checkbox" class="pull-right" id="attach_free" name="free_product" value="1" <?php echo set_checkbox('free_product', '1',$product->free_product == 1); ?>>
                            ...
                            <div class="col-xs-12">
                                <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                   ...
                                   <select name="free_pro[<?php echo $i;?>]" id="free_pro_id" class="form-control" style="width: 100%;">
                                       ...
                                       <optgroup label="<?php echo $cats['name'];?>">
                                           <?php foreach($pros as $pro){?>
                                           <option <?php echo set_select("free_pro[$i]", $pro['id'],($fp && $fp['free_pro_id'] == $pro['id'])); ?> value="<?php echo $pro['id'];?>"><?php echo $pro['name'];?></option>
                                           <?php } ?>
                                       </optgroup>
                               ...
                               <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                   ...
                                   <input type="text" placeholder="" name="free_quantity[<?php echo $i;?>]" id="free_quantitys" value="<?php echo set_value("free_quantity[$i]",$fp?$fp['quantity']:1);?>" class="form-control">
                               </div>
                            </div>
                        <?php } ?>
                    </div>
