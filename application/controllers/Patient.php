...
//	$this->data['patients'] = $this->patient->getAllPatients();
...
//        $this->data['pps'] = $this->product->getPpPros();
    ...
    public function getPatients()
    {
        ...
        foreach($fetch_data as $row)
        {
            ...
            if($user->type == 1){ $action .= '<a onclick="return confirm(\'Are you sure?\')" href="'.site_url("patient/remove/$row->id").'" style="color: #31b0d5;">Del</a> &nbsp;&nbsp;|&nbsp;&nbsp;';}
            $action .= '<a href="'.site_url("patient/view/$row->id").'" style="color: #31b0d5;">View</a>';         
            if($user->type == '1' && FALSE){ $action .= '&nbsp;&nbsp;|&nbsp;&nbsp;<a href="#" data-name="'.$row->lname.' '.$row->fname.'" data-patientid="'.$row->id.'" class="add_pp" style="color: #31b0d5;">Add PP</a>';}
            if($row->vcount > 0){
