...
class Pdmp extends CI_Controller
{
    public function gen($loc,$date)
    {
        ...
        if(empty($loc)) die('Please correct the url with correct location id');
        ...
        $ndc = array(19=>'6485081010',20=>'00527131010',21=>'5122420370',22=>'10702004401', 149 =>'6485081010');
...
// //            return $file_name;
//         }
        echo "Generating: ".$start." - ".$loc_id."<br>";
    exit();
    }
...
//                print_r($message);
    ...
    {
        $begin = new DateTime('2018-08-23');
        $end = new DateTime('2018-08-29');
...
//                echo "Generating: ".$date." - ".$date." - ".$loc."<br>";
    ...
    public function genPDMP($loc_id=null)
    {  
        $this->load->model("Cron_model", "cron");
        $this->load->helper('file');
